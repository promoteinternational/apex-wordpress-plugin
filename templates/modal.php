    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="<?= $modalContentStyles ?>">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel"><?php _e('Registration on Event') ?></h5>
            ...
            <div class="modal-body">
                ...
                <form action="<?= get_site_url(); ?>/courses/<?= $post->post_name ?>"
                      method="post">
                    <div class="row">
                        <div class="col-6 ">
                        ...
                        <div class="col-12">
                            ...
                            <input type="submit"  id="formSubmit" class="btn btn-primary"
                                   value="<?php _e('Apply') ?>" style="<?= $modalButtonStyles ?>">
                        </div>
