...
<section class="apex-courses" style="<?= $sectionStyles ?>">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="apex-courses__price">
                    <div class="apex-courses__price-title" style="<?= $priceTitleStyles ?>">
                        <?php _e('    Prices and upcoming dates:') ?>
                    </div>
                        ...
                        if (!empty($event->id) && $currentDate <= $eventDate  ) {
                            ...
                            <div class="apex-courses__event" style="<?= $eventStyles ?>">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <?php else: ?>
                                        <div class="alert alert-warning"> <?php _e('The event is full!') ?> </div>
                                    <?php endif;
                                ...
                                if (!empty($_POST['event_id']) && $_POST['event_id'] == $event->id):?>
                                    <div class="apex-courses__confirmation">
                                        <?php
                                        $api->addParticipant($_POST['first_name'], $_POST['last_name'], $_POST['company'], $_POST['email'], $_POST['phone'], $_POST['country'], $_POST['city'], $_POST['address'], $_POST['zip_code'], $_POST['event_id']);
